...
export const ABILITY_VERIFICATION_SCENARIOS: AbilityVerificationScenario[] = [
  ...
  },
  {
    ...
    playerRaceUpgradeIds: [],
    playerTroopClassUpgradeIds: ['avenger-witness'],
    enemyRaceUpgradeIds: [],
    enemyTroopClassUpgradeIds: [],
  ...
  },
  {
    ...
    summary: 'An Avenger should redirect incoming damage through a touching ally.',
    seed: 74,
    player: selection({ 'troll/avenger': startCount('troll/avenger'), 'human/soldier': startCount('human/soldier') }),
    enemy: selection({ 'human/soldier': startCount('human/soldier', 2) }),
    playerRaceUpgradeIds: [],
    playerTroopClassUpgradeIds: ['avenger-wages-of-virtue'],
    enemyRaceUpgradeIds: [],
    enemyTroopClassUpgradeIds: [],
    coveredAbilityIds: ['wages-of-virtue'],
    signals: [{ id: 'redirect', label: 'Damage is redirected', match: 'redirects damage' }],
    manualChecks: [
      'Confirm the damage lands on an adjacent ally when one is available.',
      'Confirm repeated redirects do not cycle back into the original Avenger.',
    ],
  },
  {
    id: 'beastmaster-throwing-opening',
    group: 'Attack Modifiers',
    label: 'Throwing Axes + Opening',
    summary: 'A backline Beastmaster should attack at range and cause allies touching the target to join in.',
    seed: 75,
    player: selection({ 'goblin/beastmaster': startCount('goblin/beastmaster'), 'human/soldier': startCount('human/soldier') }),
    enemy: selection({ 'human/knight': startCount('human/knight') }),
    playerRaceUpgradeIds: [],
    playerTroopClassUpgradeIds: ['beastmaster-throwing-axes', 'beastmaster-opening'],
    enemyRaceUpgradeIds: [],
    enemyTroopClassUpgradeIds: [],
    coveredAbilityIds: ['throwing-axes', 'opening'],
    signals: [{ id: 'opening', label: 'Adjacent ally follows up', match: 'Human Soldier hits Human Knight' }],
    manualChecks: [
      'Confirm the Beastmaster is fighting from range rather than walking in as a frontline unit.',
      "Confirm its hit includes extra damage from the target's current health before armor is applied.",
    ],
  },
  {
  ...
  },
  {
    ...
    enemy: selection({ 'human/knight': startCount('human/knight', 2) }),
    playerRaceUpgradeIds: [],
    playerTroopClassUpgradeIds: ['elementalist-crackling-mitosis'],
    enemyRaceUpgradeIds: [],
    enemyTroopClassUpgradeIds: [],
  ...
  },
  {
    ...
    enemy: selection({ 'human/knight': startCount('human/knight') }),
    playerRaceUpgradeIds: [],
    playerTroopClassUpgradeIds: ['militia-rat-behavior'],
    enemyRaceUpgradeIds: [],
    enemyTroopClassUpgradeIds: [],
  ...
  },
  {
    ...
    enemy: selection({ 'human/soldier': startCount('human/soldier', 2) }),
    playerRaceUpgradeIds: [],
    playerTroopClassUpgradeIds: ['necromancer-explosion-corpse'],
    enemyRaceUpgradeIds: [],
    enemyTroopClassUpgradeIds: [],
  ...
  },
  {
    ...
    playerTroopClassUpgradeIds: ['ranger-shadows-embrace'],
    enemyRaceUpgradeIds: [],
    enemyTroopClassUpgradeIds: [],
  ...
  },
  {
    id: 'troll-last-stand',
    group: 'Death Responses',
    label: 'Mossblood + Gargantuan Zeal',
    summary: 'A troll should seed Zeal at battle start and survive lethal damage once at 25 HP.',
    seed: 104,
    player: selection({ 'troll/soldier': startCount('troll/soldier') }),
    enemy: selection({ 'human/soldier': startCount('human/soldier', 3) }),
    playerRaceUpgradeIds: ['troll-mossblood', 'troll-gargantuan-zeal'],
    playerTroopClassUpgradeIds: [],
    enemyRaceUpgradeIds: [],
    enemyTroopClassUpgradeIds: [],
    coveredAbilityIds: ['stoneblood', 'gargantuan-zeal'],
    signals: [
      { id: 'zeal', label: 'Zeal seeded', match: 'gains 1 Zeal stack' },
      { id: 'stoneblood', label: 'Troll survives at 25 HP', match: 'stays at 25 HP' },
    ],
    manualChecks: [
      'Confirm Regen is gone after Stoneblood triggers.',
      'Confirm Gargantuan Zeal adds damage based on the unit size.',
    ],
  },
];
