...
export const ABILITY_VERIFICATION_SCENARIOS: AbilityVerificationScenario[] = [
  ...
  },
  {
    ...
    summary: 'An engaged Beastmaster should have a same-hex wolf redirect and heal.',
    seed: 74,
  ...
  },
  {
    ...
    label: 'True Form + Thornhide + Fade Into Shadow',
    ...
    playerFactionUpgradeIds: ['elf-fade-into-shadow'],
  ...
  },
  {
    ...
    label: 'Rabble Rush',
    summary: 'Stacked Militia should gain initiative from each other Militia on their hex.',
    seed: 25,
    ...
    manualChecks: ['Confirm the bonus scales from other Militia on the same hex, not from all allies globally.'],
  },
  {
  ...
  },
  {
    ...
    group: 'Attack Modifiers',
    label: "Skirmisher's Step + Heartseeker + Long Shot Doctrine",
    ...
    enemy: selection({ 'human/soldier': startCount('human/soldier', 2) }),
    playerFactionUpgradeIds: ['elf-long-shot-doctrine'],
  ...
  },
  {
    ...
    label: 'Spell Echo + Snatch the Moment',
    ...
    playerFactionUpgradeIds: ['goblin-snatch-the-moment'],
    ...
    manualChecks: [
      'Confirm the Blast chain produces multiple successive blast steps from one Wizard action without revisiting the same hex.',
  ...
  },
  {
    id: 'troll-last-stand',
    group: 'Death Responses',
    label: 'Stoneblood + Crushing Sweep',
    ...
    enemy: selection({ 'human/soldier': startCount('human/soldier', 3) }),
    playerFactionUpgradeIds: ['troll-stoneblood', 'troll-crushing-sweep'],
    playerTroopTypeUpgradeIds: [],
    enemyFactionUpgradeIds: [],
    enemyTroopTypeUpgradeIds: [],
